...
<?php
	...
	{		
 		...
 		$qry = Insert('tbl_buyer_whychooseb',$data);	
	...
	{			 
		$qry="SELECT * FROM tbl_buyer_whychooseb where id='".$_GET['edit_id']."'";
	...
	if(isset($_POST['submit']) and isset($_POST['edit_id']))
	{
		   ...
		   $data = array( 
			'benefite'  =>  $_POST['benefite']
				 ...
				 $category_edit=Update('tbl_buyer_whychooseb', $data, "WHERE id = '".$_POST['edit_id']."'");
