                ...
                <div class="QA_section">
                    <div class="white_box_tittle list_header">
                        ...
                        <div class="box_right d-flex lms_block">
                            ...
                            <a href="add-faqs.php?cat=cust" class="btn_1">Add New</a>
                            </div>
                        </div>
                    </div>
                    <div class="QA_table ">
                        ...
                        <table class="table lms_table_active">
                            ...
                            <tbody>
                                <?php
                                $sql = 'SELECT tbl_faqs_customer.* , id AS fcid FROM tbl_faqs_customer';
                                ...
                                ?>
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <form class="d-inline" action="faqs-customer.php" method="post" onsubmit="return confirm('are you sure');">
                                                    <!-- delete -->
                                                    <input type="hidden" name="fcid" value="<?php echo $row['fcid'] ?>" />
                                                    <button type="submit" name="del" id="" class="fas fa-trash-alt text-danger border border-0 bg-white">
                                                </form>&nbsp&nbsp
                                                <form class="d-inline" action="update-faqs.php" method="get">
                                                    <!-- update -->
                                                    <input type="hidden" value="<?php echo $row['fcid'] ?>" name="fcid" />
                                                    <button type="submit" name="update-faqs-cust" value="cust" id="" class="fas fa-edit  border border-0 bg-white">
                                                </form>
