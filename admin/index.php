...
$conn = mysqli_connect('localhost', 'rndtd_trading_user', 'Qwaszx@123', 'rndtd_trading_db');
if (!$conn) {
...
if (isset($_POST['login'])) {
    ...
    $query = "SELECT tbl_user.id AS uid, tbl_user.name AS uname , tbl_role.name as role , tbl_dept.name as dept , tbl_user.dept_id as dept_id FROM tbl_user 
    JOIN tbl_role ON tbl_user.role_id = tbl_role.id 
    JOIN tbl_dept ON tbl_user.dept_id = tbl_dept.id WHERE email = ? AND password =?";
    ...
    // Fetch the result
    $result = mysqli_stmt_bind_result($stmt,$uid,$uname,$role,$dept,$dept_id);
        ...
        <div class="container-fluid h-custom">
            <div class="row d-flex justify-content-center align-items-center h-100">
                <div class="col-md-9 col-lg-6 col-xl-5">
                    <img src="./assets/img/loginPicture.jpg" class="img-fluid" alt="Sample image">
                </div>
