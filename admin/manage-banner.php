...
if (isset($_POST['delete'])) {
    ...
    deleteRecord('tbl_banner', 'id=' . $del);
}
                    ...
                    <div class="white_box_tittle list_header">
                        ...
                        <div class="box_right d-flex lms_block">
                            ...
                            <div class="add_button ms-2">
                                <a href="add-home-banner.php?add=yes" class="btn_1">Add New</a>
                            </div>
                        </div>
                    </div>
                    <div class="QA_table ">
                            ...
                            <tbody>
                                ...
                                ?>
                                        <tr id="<?php echo $row['id'] ?>">
                                            ...
                                            <td><?php if($row['banner_image']!=""){?>
                        						<img height="70" width="100" style="object-fit:cover;" src="images/banner/<?php echo $row['banner_image'];?>" />
                                            ...
                                            <td>
                                                ...
                                                <form class="d-inline" action="add-home-banner.php" method="get">
                                                    <!-- update -->
