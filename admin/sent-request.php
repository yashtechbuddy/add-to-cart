...
if (isset($_POST['delinq']) && isset($_POST['inq_id'])) {
    ...
    $query = "DELETE FROM tbl_manage_inquiry WHERE inquiry_id = '$inq_id' AND product_id = $pro_id";
                        ...
                        <table class="table lms_table_active">
                            ...
                            <tbody>
                               <?php
                                ...
                                $autogenerated_id = $_GET['inquiryId'];
                                
                               $sql = "SELECT
                                        DISTINCT_SUBQUERY.product_name,
                                        DISTINCT_SUBQUERY.product_id,
                                        tbl_categories.category_name,
                                        tbl_manage_inquiry.id AS manage_inquiry_id,
                                        tbl_manage_inquiry.volume_name,
                                        tbl_manage_inquiry.quantity,
                                        tbl_inquiry_status.status AS statuses
                                    FROM (
                                        SELECT
                                            tbl_product.id AS product_id,
                                            tbl_product.product_name,
                                            tbl_inquiry_status.status AS status,
                                            tbl_manage_inquiry.inquiry_id
                                        ...
                                        WHERE tbl_manage_inquiry.inquiry_id = '$autogenerated_id'
                                    ) AS DISTINCT_SUBQUERY
                                    JOIN tbl_product ON DISTINCT_SUBQUERY.product_id = tbl_product.id
                                    JOIN tbl_categories ON tbl_product.category_id = tbl_categories.id
                                    JOIN tbl_manage_inquiry ON DISTINCT_SUBQUERY.inquiry_id = tbl_manage_inquiry.inquiry_id
                                    JOIN tbl_inquiry_status ON tbl_manage_inquiry.status_id = tbl_inquiry_status.id
                                    GROUP BY DISTINCT_SUBQUERY.product_name, tbl_categories.category_name";
                                ...
                                <tr>
                                    ...
                                    <!--<td><?php echo $inquiryDetail['statuses']; ?></td>-->
                                    <td>
                                    
                                      <button class="fa-solid fa-eye border border-0 bg-white" onclick="redirectToPage('<?php echo $autogenerated_id ?>','<?php echo $inquiryDetail['product_id'] ?>')">
                                        &nbsp;&nbsp;
                                      ...
                                      <form class="d-inline" method="post">
                                            <!-- delete -->
                                            <input type="hidden" value="<?php echo $autogenrated_id ?>" name="inq_id" />
                                            <input type="hidden" value="<?php echo $inquiryDetail['product_id'] ?>" name="pro_id" />
                                ...
                                <?php
                                 ...
                                 <script>
                                    function redirectToPage(inquiryId,product_id) {
                                        window.location.href = 'sent-request-detail.php?inquiryId=' + inquiryId + '&product_id=' + product_id;
                                    }
                                </script> 
                            </tbody>
                        </table>
