...
if (isset($_POST['benefite_update'])) {
    ...
    foreach ($image_data as $image_column) {
        if (isset($_FILES[$image_column]) && $_FILES[$image_column]['error'] === 0) {
            $select_image_query = "SELECT $image_column FROM tbl_supplier_benefite WHERE id = 1";
            ...
            $update_image_query = "UPDATE tbl_supplier_benefite SET $image_column='$image_name' WHERE id = 1";
            mysqli_query($conn, $update_image_query);
        }
    }
    
    $update_query = "UPDATE tbl_supplier_benefite SET ";
    ...
    if (mysqli_query($conn, $update_query)) {
        ...
        echo "window.location.href = 'supplier-benefits.php';</script>";
    } else {
            ...
            <div class="col-12">
                <div class="QA_section">
                    <div class="white_box_tittle list_header">
                        <h4>Supplier Benefite</h4>
                    </div>
                    <?php

                    $Select = 'SELECT * FROM `tbl_supplier_benefite`  where id=1';
                                ...
                                <form class="" method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="mb-3 row col-12">
                                        ...
                                        <div class="form-group row mt-4">
                                            ...
                                            <div class="col-sm-9">
                                                <textarea  name="description" class="form-control" id="desc" ><?php echo $rows['description']; ?></textarea>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group  row">
                                                ...
                                                <div class="col-sm-9">
                                                    <div class="fileupload_block">
                                                        ...
                                                        <img style="object-fit:cover;" src="images/supplier/<?php echo $rows['image_b1']; ?>" alt="benefite 1" />
                                        ...
                                        <div class="form-group row">
                                                ...
                                                <div class="col-sm-9">
                                                    <div class="fileupload_block">
                                                        ...
                                                        <img style="object-fit:cover;" src="images/supplier/<?php echo $rows['image_b2']; ?>" alt="benefite 2" />
                                        ...
                                        <div class="form-group row">
                                                ...
                                                <div class="col-sm-9">
                                                    <div class="fileupload_block">
                                                        ...
                                                        <img style="object-fit:cover;" src="images/supplier/<?php echo $rows['image_b3']; ?>" alt="benefite 3" />
                                        ...
                                        <div class="form-group row">
                                                ...
                                                <div class="col-sm-9">
                                                    <div class="fileupload_block">
                                                        ...
                                                        <img style="object-fit:cover;" src="images/supplier/<?php echo $rows['image_b4']; ?>" alt="benefite 4" />
