...
// include 'includes/config.php';
    ...
    { 
        ...
        deleteRecord('tbl_supplier_whychooseb', 'id=' .  $b_id);
                ...
                <div class="QA_section">
                    <div class="white_box_tittle list_header">
                        ...
                        <div class="box_right d-flex lms_block">
                            ...
                            <a href="whychoose_static_s.php" class="btn_1">Manage Static Data</a>
                            </div>
                            <div class="add_button ms-2">
                            <a href="add-whychoose-benefite_s.php?add=yes" class="btn_1">Add New</a>
                            </div>
                        </div>
                    </div>
                    <div class="QA_table ">
                        ...
                        <table class="table lms_table_active">
                            ...
                            <tbody>
                                <?php
                                    ...
                                    $cno = 1;
                                    $buyerwhychoose = "SELECT * FROM tbl_supplier_whychooseb";
                                ...
                                ?>
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <form class="d-inline" action="add-whychoose-benefite_s.php" method="get">
                                                    <!-- update -->
