...
<body class="theme-creote right-sidebar">
                                 ...
                                 <ul id="myNavbar" class="navbar_nav">
                                                      ...
                                                      <ul>
                                                         <li>
                                                            <small class="d-flex align-items-center">
                                                               ...
                                                               <a class="nav_link" href="index.php">Home Page - 01</a>
                                                            </small>
                                                         </li>
                                                         <li>
                                                            <small class="d-flex align-items-center">
                                                               <i class="icon-home only_icon"></i>
                                                               <a class="nav_link" href="index.php">Home Page - 02</a>
                                                            </small>
                                                         </li>
                                                         <li>
                                                            <small class="d-flex align-items-center">
                                                               <i class="icon-home only_icon"></i>
                                                               <a class="nav_link" href="home-3.php">Home Page - 03</a>
                                                            </small>
                                                         </li>
                                                         <li>
                                                            <small class="d-flex align-items-center">
                                                               <i class="icon-home only_icon"></i>
                                                               <a class="nav_link" href="home-4.php">Home Page - 04</a>
                                                            </small>
                                                         </li>
                                                   ...
                                                   <div class="list_item_box style_one">
                                                      <ul>
                                                         <li>
                                                            <small class="d-flex align-items-center">
                                                              <i class="icon-home only_icon"></i>
                                                               <a class="nav_link" href="home-5.php">Home Page - 05</a>
                                                            </small>
                                                         </li>
                                                         <li>
                                                            <small class="d-flex align-items-center">
                                                               <i class="icon-home only_icon"></i>
                                                               <a class="nav_link" href="home-6.php">Home Page - 06</a>
                                                            </small>
                                                         </li>
                                                         <li>
                                                            <small class="d-flex align-items-center">
                                                               <i class="icon-home only_icon"></i>
                                                               <a class="nav_link" href="home-7.php">Home Page - 07</a>
                                                            </small>
                                                         </li>
                                                         <li>
                                                            <small class="d-flex align-items-center">
                                                               <i class="icon-home only_icon"></i>
                                                               <a class="nav_link" href="home-8.php">Home Page - 08</a>
                                                            </small>
                                                         </li>
                                                      </ul>
                                                   </div>
                                                   ...
                                                   <div class="list_item_box style_one">
                                                      <ul>
                                                         ...
                                                         <li>
                                                            <small class="d-flex align-items-center">
                                                               <i class="icon-home only_icon"></i>
                                                               <a class="nav_link" href="home-9.php">Home Page - 09</a>
                                                            </small>
                                                         </li>
                                                         <li>
                                                            <small class="d-flex align-items-center">
                                                               <i class="icon-home only_icon"></i>
                                                               <a class="nav_link" href="home-10.php">Home Page - 10</a>
                                                            </small>
                                                         </li>
                                                         <li>
                                                            <small class="d-flex align-items-center">
                                                               <i class="icon-home only_icon"></i>
                                                               <a class="nav_link" href="home-11.php">Home Page - 11</a>
                                                            </small>
                                                         </li>
                                                         <li>
                                                            <small class="d-flex align-items-center">
                                                               <i class="icon-home only_icon"></i>
                                                               <a class="nav_link" href="home-12.php">Home Page - 12</a>
                                                            </small>
                                                         </li>
                                                      </ul>
                                                   </div>
                                                   ...
                                                   <div class="list_item_box style_one">
                                                      <ul>
                                                         <li>
                                                            <small class="d-flex align-items-center">
                                                               <i class="icon-home only_icon"></i>
                                                               <a class="nav_link" href="home-13.php">Home Page - 13</a>
                                                            </small>
                                                         </li>
                                                         <li>
                                                            <small class="d-flex align-items-center">
                                                               <i class="icon-home only_icon"></i>
                                                               <a class="nav_link" href="home-14.php">Home Page - 14</a>
                                                            </small>
                                                         </li>
                                                         <li>
                                                            <small class="d-flex align-items-center">
                                                               <i class="icon-home only_icon"></i>
                                                               <a class="nav_link" href="home-15.php">Home Page - 15</a>
                                                            </small>
                                                         </li>
                                                         <li>
                                                            <small class="d-flex align-items-center">
                                                               <i class="icon-home only_icon"></i>
                                                               <a class="nav_link" href="home-16.php">Home Page - 16</a>
                                                            </small>
                                                         </li>
                                    ...
                                    <li
                                       ...
                                       <ul class="dropdown-menu">
                                          ...
                                          <li
                                             class="menu-item menu-item-has-children dropdown nav-item">
                                             <a href="service-default.php"
                                                class="dropdown-item nav-link"><span>Service</span></a>
                                             <ul class="dropdown-menu">
                                                <li
                                                   class="menu-item  nav-item">
                                                   <a href="service-classic.php" class="dropdown-item nav-link">
                                                      <span>Service Classic</span>
                                                   </a>
                                                </li>
                                                <li
                                                   class="menu-item  nav-item">
                                                   <a href="service-default.php" class="dropdown-item nav-link">
                                                      <span>Service Default</span>
                                                   </a>
                                                </li>
                                                <li
                                                   class="menu-item nav-item">
                                                   <a href="service-details.php" class="dropdown-item nav-link">
                                          ...
                                          <li class="menu-item  nav-item">
                                             <a href="pricing-packages.php" class="dropdown-item nav-link">
                                          ...
                                          <li class="menu-item  nav-item">
                                             <a href="faqs.php" class="dropdown-item nav-link">
                                                <span>Faq’s</span>
                                             </a>
                                          </li>
                                          <li class="menu-item  nav-item">
                                          ...
                                          <li class="menu-item  nav-item">
                                             <a href="coming-soon.php" class="dropdown-item nav-link">
                                          ...
                                          <li>
                                             <div class="row">
                                                <div class="col-lg-2 m_column">
                                                   ...
                                                   <div class="list_item_box style_one">
                                                      <ul>
                                                         <li><a href="elements/testimonial.php">Testimonial</a></li>
                                                         <li><a href="elements/call-to-action.php">Contact List</a></li>
                                                         <li><a href="elements/video-button.php">Video Button</a></li>
                                                         <li><a href="elements/newsteller.php">Newsteller</a></li>
                                                         <li><a href="elements/blog-posts.php">Blog Posts</a></li>
                                                         <li><a href="elements/team.php">Team</a></li>
                                                      </ul>
                                                   </div>
                                                </div>
                                                <div class="col-lg-2 m_column">
                                                   ...
                                                   <div class="list_item_box style_one">
                                                      <ul>
                                                         <li><a href="elements/process.php">Process</a></li>
                                                         <li><a href="elements/project-carousel.php">Project Carousel</a></li>
                                                         <li><a href="elements/project-filter.php">Project Filter</a></li>
                                                         <li><a href="elements/progress-bar.php">Progress Bar</a></li>
                                                         <li><a href="elements/content-box.php">Content Box</a></li>
                                                         <li><a href="elements/faqs-elements.php">Faq’s</a></li>
                                                      </ul>
                                                   </div>
                                                </div>
                                                <div class="col-lg-2 m_column">
                                                   ...
                                                   <div class="list_item_box style_one">
                                                      <ul>
                                                         ...
                                                         <li><a href="elements/list-items.php">List Items</a></li>
                                                         <li><a href="elements/contact-form.php">Contact Form</a></li>
                                                         <li><a href="elements/service-post.php">Service Post</a></li>
                                                         <li><a href="elements/sliders.php">Sliders</a></li>
                                                ...
                                                <div class="col-lg-2 m_column">
                                                   ...
                                                   <div class="list_item_box style_one">
                                                      <ul>
                                                         <li><a href="elements/call-to-action.php">Call to Action</a></li>
                                                         <li><a href="elements/extra-content.php">Extra Content</a></li>
                                                         <li><a href="elements/simple-image.php">Simple Image</a></li>
                                                         <li><a href="elements/client-image.php">Client Image</a></li>
                                                         <li><a href="elements/price-plan.php">Price Plan</a></li>
                                                         <li><a href="elements/title.php">Title</a></li>
                                                      </ul>
                                                   </div>
                                                </div>
                                                <div class="col-lg-2 m_column">
                                                   ...
                                                   <div class="list_item_box style_one">
                                                      <ul>
                                                         <li><a href="elements/service-box.php">Service Box</a></li>
                                                         <li><a href="elements/count-down.php">Count Down</a></li>
                                                         <li><a href="elements/timeline.php">Time Line</a></li>
                                                         <li><a href="elements/contact-box.php">Contact Box</a></li>
                                                      </ul>
                                                   </div>
                                                </div>
                                                <div class="col-lg-2 m_column">
                                                   ...
                                                   <div class="list_item_box style_one">
                                                      <ul>
                                                         ...
                                                         <li><a href="elements/fun-facts.php">Fun Facts</a></li>
                                                         <li><a href="elements/quotes.php">Quotes</a></li>
                                                      </ul>
                                                   </div>
                                                </div>
                                             </div>
                                    ...
                                    <li
                                       ...
                                       <ul class="dropdown-menu">
                                          <li class="menu-item nav-item">
                                             <a href="blog.php" class="dropdown-item nav-link">
                                                <span>Blog Classic</span>
                                             </a>
                                          </li>
                                          <li class="menu-item  nav-item">
                                             <a href="blog-modern.php" class="dropdown-item nav-link">
                                                <span>Blog Modern</span>
                                             </a>
                                          </li>
                                          <li class="menu-item  nav-item">
                                             <a href="blog-simple.php" class="dropdown-item nav-link">
                                                <span>Blog Simple</span>
                                             </a>
                                          </li>
                                          <li class="menu-item  nav-item">
                                             <a href="blog-list-view.php" class="dropdown-item nav-link">
                                                <span>Blog List View</span>
                                             </a>
                                          </li>
                                          <li class="menu-item  nav-item">
                                             <a href="blog-metro-fullwidth.php" class="dropdown-item nav-link">
                                                <span>Metro Fullwidth</span>
                                             </a>
                                          </li>
                                          <li class="menu-item nav-item">
                                             <a href="blog-single.php" class="dropdown-item nav-link">
                                    ...
                                    <li
                                       class="menu-item menu-item-has-children dropdown nav-item">
                                       <a href="project-1-column-grid.php" class="dropdown-toggle nav-link">
                                          <span>Projects</span>
                                       </a>
                                       <ul class="dropdown-menu">
                                          <li class="menu-item  nav-item">
                                             <a href="project-1-column-grid.php" class="dropdown-item nav-link">
                                                <span>1 Column Grid</span>
                                             </a>
                                          </li>
                                          <li class="menu-item  nav-item">
                                             <a href="project-1-column-with-sidebar.php"
                                                class="dropdown-item nav-link">
                                                <span>1 Column With Sidebar</span>
                                             </a>
                                          </li>
                                          <li class="menu-item  nav-item">
                                             <a href="project-2-column-grid.php" class="dropdown-item nav-link">
                                                <span>2 Columns Grid</span>
                                             </a>
                                          </li>
                                          <li class="menu-item  nav-item">
                                             <a href="project-3-column-grid.php" class="dropdown-item nav-link">
                                                <span>3 Columns Grid</span>
                                             </a>
                                          </li>
                                          <li class="menu-item  nav-item">
                                             <a href="project-3-column-overlay.php" class="dropdown-item nav-link">
                                                <span>3 Columns Overlay</span>
                                             </a>
                                          </li>
                                          <li class="menu-item nav-item">
                                             <a href="project-details.php" class="dropdown-item nav-link">
                                    ...
                                    <li
                                       class="menu-item  menu-item-has-children dropdown nav-item">
                                       <a href="shop.php" class="dropdown-toggle nav-link">
                                          <span>Shop</span>
                                       </a>
                                       <ul class="dropdown-menu">
                                          <li class="menu-item  nav-item">
                                             <a href="shop.php" class="dropdown-item nav-link">
                                                <span>Products</span>
                                             </a>
                                          </li>
                                          <li class="menu-item nav-item">
                                             <a href="shop-details.php" class="dropdown-item nav-link">
                                                <span>Product Details</span>
                                             </a>
                                          </li>
                                          <li class="menu-item nav-item">
                                             <a href="shop-with-sidebar.php" class="dropdown-item nav-link">
                                                <span>Product With Sidebar</span>
                                             </a>
                                          </li>
                                          <li class="menu-item  nav-item">
                                             <a href="my-account.php" class="dropdown-item nav-link">
                                                <span>My account</span>
                                             </a>
                                          </li>
                                          <li class="menu-item  nav-item">
                                             <a href="checkout.php" class="dropdown-item nav-link">
                                                <span>Checkout</span>
                                             </a>
                                          </li>
                                          <li class="menu-item  nav-item">
                                             <a href="cart.php" class="dropdown-item nav-link">
                                                <span>Cart</span>
                                             </a>
                                          </li>
                                       </ul>
                        ...
                        <article id="" class="clearfix service type-service status-publish has-post-thumbnail hentry">
                           <div class="row grid_layout">
                              <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 grid_box">
                                 <div class="news_box style_one blog_classic has_images">
                                    ...
                                    <div class="content_box">
                                       ...
                                       <h2 class="title"><a href="blog-single.php" rel="bookmark">Why Should Business
                              ...
                              <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 grid_box">
                                 <div class="news_box style_one blog_classic has_images">
                                    ...
                                    <div class="content_box">
                                       ...
                                       <h2 class="title"><a href="blog-single.php" rel="bookmark">Most Employees
                                             Support Measures</a></h2>
                                    </div>
                                 </div>
                              </div>
                              <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 grid_box">
                                 <div class="news_box style_one blog_classic has_images">
                                    <div class="image img_hover-1">
                                       <img width="750" height="420" src="assets/images/blog/blog-image-7.jpg"
                                          class="wp-post-image" alt="img">
                                       <a class="arrow" href="#">
                                          <i class="fa fa-angle-right"></i>
                                       </a>
                                    ...
                                    <div class="content_box">
                                       ...
                                       <h2 class="title"><a href="blog-single.php" rel="bookmark">How to Handle
                                             Employee</a></h2>
                                    </div>
                                 </div>
                              </div>
                              <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 grid_box">
                                 <div class="news_box style_one blog_classic has_images">
                                    ...
                                    <div class="content_box">
                                       ...
                                       <a href="#" class="categories"><i class="icon-folder"></i>Coaching</a>
                                       <h2 class="title"><a href="blog-single.php" rel="bookmark">Retaining Good
                                             Employees & Motivated</a></h2>
                                    </div>
                                 </div>
                              </div>
                              <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 grid_box">
                                 <div class="news_box style_one blog_classic has_images">
                                    <div class="image img_hover-1">
                                       <img width="750" height="420" src="assets/images/blog/blog-image-5.jpg"
                                          class="wp-post-image" alt="img">
                                       <a class="arrow" href="#">
                                          <i class="fa fa-angle-right"></i>
                                       </a>
                                    ...
                                    <div class="content_box">
                                       ...
                                       <a href="#" class="categories"><i class="icon-folder"></i>Compliance Audits</a>
                                       <h2 class="title"><a href="blog-single.php" rel="bookmark">Understanding
                                             Executive Coaching</a></h2>
                                    </div>
                                 </div>
                              </div>
                              <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 grid_box">
                                 <div class="news_box style_one blog_classic has_images">
                                    <div class="image img_hover-1">
                                       <img width="750" height="420" src="assets/images/blog/blog-image-4.jpg"
                                          class="wp-post-image" alt="img">
                                       <a class="arrow" href="#">
                                          <i class="fa fa-angle-right"></i>
                                       </a>
                                    ...
                                    <div class="content_box">
                                       ...
                                       <a href="#" class="categories"><i class="icon-folder"></i>Coaching</a>
                                       <h2 class="title"><a href="blog-single.php" rel="bookmark">How to Handle Your
                                             Good Employee</a></h2>
                                    </div>
                                 </div>
                              </div>
                              <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 grid_box">
                                 <div class="news_box style_one blog_classic has_images">
                                    <div class="image img_hover-1">
                                       <img width="750" height="420" src="assets/images/blog/blog-image-3.jpg"
                                          class="wp-post-image" alt="img">
                                       <a class="arrow" href="#">
                                          <i class="fa fa-angle-right"></i>
                                       </a>
                                    ...
                                    <div class="content_box">
                                       ...
                                       <a href="#" class="categories"><i class="icon-folder"></i>Employee Relations</a>
                                       <h2 class="title"><a href="blog-single.php" rel="bookmark">Workforce Challenges
                                             & Opportunities</a></h2>
                                    </div>
                                 </div>
                              </div>
                              <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 grid_box">
                                 <div class="news_box style_one blog_classic has_images">
                                    <div class="image img_hover-1">
                                       <img width="750" height="420" src="assets/images/blog/blog-image-11.jpg"
                                          class="wp-post-image" alt="img">
                                       <a class="arrow" href="#">
                                          <i class="fa fa-angle-right"></i>
                                       </a>
                                    ...
                                    <div class="content_box">
                                       ...
                                       <a href="#" class="categories"><i class="icon-folder"></i>Coaching</a>
                                       <h2 class="title"><a href="blog-single.php" rel="bookmark">Workplace problems in
                                             your business?</a></h2>
                                    </div>
                                 </div>
                              </div>
                              <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 grid_box">
                                 <div class="news_box style_one blog_classic has_images">
                                    <div class="image img_hover-1">
                                       <img width="750" height="420" src="assets/images/blog/blog-image-10.jpg"
                                          class="wp-post-image" alt="img">
                                       <a class="arrow" href="#">
                                          <i class="fa fa-angle-right"></i>
                                       </a>
                                    ...
                                    <div class="content_box">
                                       ...
                                       <a href="#" class="categories"><i class="icon-folder"></i>Employee Relations</a>
                                       <h2 class="title"><a href="blog-single.php" rel="bookmark">Supporting Employees
                                             Through The Menopause Guidance For Employers</a></h2>
                                    </div>
                                 </div>
                              </div>
                              <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 grid_box">
                                 <div class="news_box style_one blog_classic has_images">
                                    <div class="image img_hover-1">
                                       <img width="750" height="420" src="assets/images/blog/blog-image-2.jpg"
                                          class="wp-post-image" alt="img">
                                       <a class="arrow" href="#">
                                          <i class="fa fa-angle-right"></i>
                                       </a>
                                    ...
                                    <div class="content_box">
                                       ...
                                       <a href="#" class="categories"><i class="icon-folder"></i>Coaching</a>
                                       <h2 class="title"><a href="blog-single.php" rel="bookmark">Policies & Procedures
                                             for Startups</a></h2>
                                    </div>
                                 </div>
                              </div>
                              ...
                              <div class="col-lg-12">
                                 <nav aria-label="Page navigation example">
                                    <ul class="pagination text-center">
                                       <li class="active">
                                          <a href="blog-simple.php">1</a>
                                       </li>
                                       <li>
                                          <a href="blog-simple.php">2</a>
                                       </li>
                                       <li class="next_link">
                                          <a href="blog-simple.php">
                  ...
                  <aside id="secondary" class="widget-area all_side_bar col-lg-4 col-md-12 col-sm-12">
                     <div class="side_bar">
                        ...
                        <div class="widgets_grid_box">
                           <form role="search" method="get" action="https://themepanthers.com/html/creote-html/index.php/">
                           ...
                           <div class="widget_post_box">
                              <div class="blog_in clearfix image_in">
                                 ...
                                 <div class="content_inner">
                                    ...
                                    <h3><a href="blog-single.php">Why Should Business Payroll Outsourcing?</a></h3>
                                 </div>
                              </div>
                              <div class="blog_in clearfix image_in">
                                 <div class="image">
                                 ...
                                 <div class="content_inner">
                                    <p class="post-date"><span class="icon-calendar"></span>October 8, 2023</p>
                                    <h3><a href="blog-single.php">Most Employees Support Measures</a></h3>
                                 </div>
                              </div>
                              <div class="blog_in clearfix image_in">
                                 <div class="image">
                                 ...
                                 <div class="content_inner">
                                    <p class="post-date"><span class="icon-calendar"></span>October 8, 2023</p>
                                    <h3><a href="blog-single.php">How to Handle Employee</a></h3>
                                 </div>
                              </div>
                              <div class="blog_in clearfix image_in">
                                 <div class="image">
                                 ...
                                 <div class="content_inner">
                                    <p class="post-date"><span class="icon-calendar"></span>October 8, 2023</p>
                                    <h3><a href="blog-single.php">Retaining Good Employees &amp; Motivated</a></h3>
                                 </div>
                              </div>
