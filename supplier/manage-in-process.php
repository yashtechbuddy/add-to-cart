                    ...
                    <div class="QA_table ">
                        ...
                        <table class="table lms_table_active">
                            ...
                            <tbody>
                                ...
                                $sql = "SELECT tbl_manage_inquiry.*,tbl_manage_inquiry.id as sent_inquiry_id ,tbl_inquiry_status.status AS status_name,tbl_product.product_name, tbl_categories.category_name from tbl_manage_inquiry
                                        ...
                                        WHERE tbl_manage_inquiry.supplier_id = $supplier_id AND tbl_manage_inquiry.sup_amount > 1 AND status_id IN (2,3,4)";
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="detailModalLabel">Your Quatation Details</h5>
