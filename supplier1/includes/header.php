...
<head>
    ...
    <link rel="icon" href="images/logo/<?php echo APP_ICON ?>" type="image/png">
    <link rel="preload"
    ...
    <script defer src="https://cdn.jsdelivr.net/npm/sweetalert2@7.12.15/dist/sweetalert2.all.min.js"></script>
